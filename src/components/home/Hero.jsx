        ...
        <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
            ...
            <div className="container mx-auto px-4 text-center z-10">
                ...
                <motion.h1
                    ...
                    className="font-display italic font-black text-6xl md:text-8xl lg:text-9xl tracking-tighter leading-[0.9] mb-6"
                >
                    <span className="text-white block neon-text text-glow" style={{ animation: 'var(--animate-flicker)' }}>WATCH</span>
                    <span className="text-transparent bg-clip-text bg-gradient-to-r from-white via-primary to-secondary block neon-text-lg">BEYOND.</span>
                </motion.h1>
                ...
                <motion.p
                    ...
                    className="max-w-2xl mx-auto text-muted text-lg md:text-xl font-light mb-10 text-glow"
                >
                ...
                >
                    <Link to="/orders">
                        <Button className="bg-primary hover:bg-secondary text-white font-black italic text-lg px-10 py-4 rounded-full shadow-glow-red hover:shadow-[0_0_30px_rgba(255,0,0,0.6)] transition-all">
                            ACCESS THE VAULT
                        </Button>
                    </Link>
                </motion.div>
            ...
            <AnimatePresence mode="wait">
                <motion.div
                    ...
                    className="fixed bottom-8 left-8 z-50 bg-black/90 backdrop-blur-xl border border-white/10 rounded-xl p-4 flex items-center gap-4 shadow-[0_0_30px_rgba(0,0,0,0.5)] overflow-hidden min-w-[240px] group cursor-default"
                >
                    <div className="absolute left-0 top-0 bottom-0 w-1 bg-primary shadow-[0_0_10px_rgba(255,0,0,1)]" />

                    {/* Ticketer Scanning Bar */}
                    ...
                    <div className="h-12 w-12 rounded-lg bg-zinc-900 flex items-center justify-center font-black text-xl text-primary italic border border-white/5 group-hover:scale-110 transition-transform">
                        {notification.plan.charAt(0)}
                    </div>
                    <div className="relative">
                        <div className="text-[10px] font-bold text-primary uppercase tracking-[0.2em] mb-0.5 flex items-center gap-2">
                        ...
                        <div className="text-[10px] text-white/60 font-bold uppercase tracking-widest mt-0.5 group-hover:text-primary transition-colors">
                            {notification.plan}
                        </div>
                    </div>
                </motion.div>
